<template>
  ...
  >
    <a
      ...
      class="border border-palette-primary text-palette-primary text-lg font-primary font-semibold pt-2 pb-1 leading-relaxed flex  justify-center items-center focus:ring-1 focus:ring-palette-light focus:outline-none w-full hover:bg-palette-lighter rounded-sm"
      href="/"
      ><svg
        aria-hidden="true"
        focusable="false"
    ...
    <div
      class=" font-primary"
      style='font-family: "Josefin Sans", Bangla162, sans-serif;'
    >
      <h1
        class="leading-relaxed font-extrabold text-3xl text-palette-primary py-2 sm:py-4"
      >
        The Fashionista
      </h1>
      <p class="font-medium text-lg">
        You know he's got his own personal stylist.
      </p>
    ...
    <div class="w-full">
        ...
        <div class="flex flex-col items-start space-y-1 flex-grow">
          ...
          ><select
            ...
            ><option
              ...
              value="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC8zNjIyNDIyNTA4MzU0Nw=="
              >3 x 3</option
            ><option
              id="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC8zNjIyNDIyNTExNjMxNQ=="
              value="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC8zNjIyNDIyNTExNjMxNQ=="
              >4 x 4</option
            ><option
              id="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC8zNjIyNDIyNTE4MTg1MQ=="
              value="Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC8zNjIyNDIyNTE4MTg1MQ=="
              >5.5 x 5.5</option
            ></select
          >
        </div>
      ...
      >
        Add To Cart<svg
          ...
          class="svg-inline--fa fa-shopping-cart fa-w-18 w-5 ml-2"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 576 512"
        >
